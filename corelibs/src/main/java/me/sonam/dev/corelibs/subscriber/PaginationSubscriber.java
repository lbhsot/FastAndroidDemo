package me.sonam.dev.corelibs.subscriber;

import java.util.List;

import me.sonam.dev.corelibs.base.BaseView;
import me.sonam.dev.corelibs.pagination.PaginationBridge;
...
public abstract class PaginationSubscriber<T> extends ResponseSubscriber<T> {
     ...
     * @param bridge {@link me.sonam.dev.corelibs.pagination.core.BasePaginationPresenter}默认实现了此接口
